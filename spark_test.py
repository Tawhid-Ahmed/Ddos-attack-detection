# -*- coding: utf-8 -*-
"""
Created on Thu Feb  9 12:08:40 2023
...
#os.environ['SPARK_HOME'] = 'C:\spark\spark-3.3.1-bin-hadoop3-scala2.13'
#os.environ["JAVA_HOME"] = 'C:\Java\jdk-19'
...
#sc = spark.sparkContext
#spark=(SparkSession.builder.appName("Ddos-test").getOrCreate())
sc = spark.sparkContext
...
def main(argv):
    ...
    if args.train is not None:
        ...
        for full_path in subfolders:
            ...
            rnd_search_cv = GridSearchCV(keras_classifier,hyperparamters,  cv=cv, refit=True,
            ...
            rnd_search_cv.fit(X_train, Y_train,epochs=args.epochs, validation_data=(X_val, Y_val), callbacks=[es, mc] )#, epochs=args.epochs, validation_data=(X_val, Y_val), callbacks=[es, mc]
